...
Campaigns like LISA DRESS and NEVIN DRESS achieved very high ROAS at lower spend, highlighting that setup optimization outperformed budget increases in driving returns
...
_ Apply clear performance thresholds: pause campaigns if ROAS < 1 after 1 – 2 optimization cycles, or if marketing profit remains negative despite optimization to prevent repeated budget 
waste in subsequent weeks
...
_ Set discount caps for high-volume SKUs to prevent margin erosion as volume scales
...
Hà Nội (36.4%) and Hồ Chí Minh City (21.1%) contribute nearly 57% of total revenue, making them the core markets. With profit margins around the system average (~10%), growth remains stable. Given the high revenue concentration, optimization in major cities will have the greatest impact on overall performance

![image alt](https://github.com/mkhanhvo/Business-Performance-Overview-Revenue-Profit-Advertising-Impact/blob/f5b05748ef0d4697cd0d2c0b823ba880fc20d542/High%20revenue%20contribution%20by%20ads.png)

### 2. Profitability by region
Some provinces generate revenue but post negative profit or margins (e.g., Trà Vinh, Kon Tum, Gia Lai) due to low volume and high cost per order. In contrast, provinces such as Hậu Giang, Cà Mau, Ninh Bình, Bắc Giang, and Bình Thuận maintain strong margins (> 15 – 20%) despite smaller scale, reflecting better cost and discount control. Profitability differences are driven by cost structure and sales policies rather than revenue scale alone, and lower volume but high margin areas show potential for scalable growth if optimized

*Low volume and high cost per order areas*

![image alt](https://github.com/mkhanhvo/Business-Performance-Overview-Revenue-Profit-Advertising-Impact/blob/b264e1149ca31ccdb476e98c7db11f925eed2efe/(2)%20City%20with%20negative%20profit%20and%20profit%20margin.png)

*Lower volume but high margin areas*

![image alt](https://github.com/mkhanhvo/Business-Performance-Overview-Revenue-Profit-Advertising-Impact/blob/b264e1149ca31ccdb476e98c7db11f925eed2efe/City%20with%20high%20margin%20despite%20small%20sales%20volume.png)

### 3. Revenue contribution by sales channel
Ads-driven revenue is concentrated in major cities and large markets such as Hà Nội, Ho Chi Minh City, Đà Nẵng and Hải Phòng. However, in smaller provinces (e.g., Trà Vinh, Kon Tum, Phú Yên, Bến Tre), ad driven profit and margins are weak or even negative, indicating that ad costs are misaligned with local purchasing power

*High revenue contribution areas*

![image alt](https://github.com/mkhanhvo/Business-Performance-Overview-Revenue-Profit-Advertising-Impact/blob/b264e1149ca31ccdb476e98c7db11f925eed2efe/High%20revenue%20contribution%20by%20ads.png)

*Low ads-driven result areas*

![image alt](https://github.com/mkhanhvo/Business-Performance-Overview-Revenue-Profit-Advertising-Impact/blob/ae6f465e69490dc5493d2dede15ff99098aaa028/(2)Low%20contribution%20city%20by%20ads.png)

Direct sales deliver more stable and higher profitability in mid-sized provinces such as Vĩnh Phúc, Tuyên Quang, Cà Mau, and Hậu Giang. While revenue contribution is modest, margins remain strong due to lower costs and better discount control. Overall, Ads are effective for scale in large markets, while Direct sales provide more sustainable profitability in non-core regions

![image alt](https://github.com/mkhanhvo/Business-Performance-Overview-Revenue-Profit-Advertising-Impact/blob/ae6f465e69490dc5493d2dede15ff99098aaa028/Hight%20profit%20margin%20city%20by%20Direct%20sales.png)

## Recommendations
_ Prioritize Ads investment in top cities, optimizing toward profit and ROAS rather than revenue alone

_ Limit Ads exposure in smaller cities, rely more on Direct sales or tightly controlled testing budgets

_ Set minimum margin thresholds at city level to proactively manage discounting and spend

_ Selectively scale cities with solid margins and moderate volume instead of broad expansion

## Summary
Revenue shows solid growth, while profitability is clearly differentiated across categories, products, regions, and sales channels. Profitability issues are primarily driven by high discount levels in certain categories and regions, particularly through advertising in smaller markets. Focusing on discount control, performance-based budget reallocation, and scaling segments with stable margins is key to improving overall business performance
